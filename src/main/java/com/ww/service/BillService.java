...
import com.ww.dao.BillDAO;
import com.ww.dao.MultiTableDAO;
import com.ww.domain.Bill;
import com.ww.domain.Menu;
import com.ww.domain.MultiTableBean;
...
public class BillService {
    ...
    public List<Bill> getList(String value) {
        List<Bill> bills = billDAO.queryMulti("select * from bill where billId = ? or state = ? ", Bill.class, value, value);
        if (bills.size() == 0) {
            bills = getBillByDiningTableId(Integer.parseInt(value));
        }
        return bills;
    }
